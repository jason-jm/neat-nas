...
**macOS 11+** (Apple Silicon et Intel, une seule version universelle) : ouvrez le `.dmg` et glissez Neat NAS dans Applications. L’app n’est pas encore notarisée, le premier lancement demande un clic droit → Ouvrir.
