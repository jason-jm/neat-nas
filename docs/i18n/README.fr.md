...
**macOS 11+** (Apple Silicon et Intel, une seule version universelle) : ouvrez le `.dmg` et glissez Neat NAS dans Applications. Elle est signée avec un Developer ID et notarisée par Apple : elle s’ouvre comme n’importe quelle autre app téléchargée.
