...
**macOS 11+** (Apple Silicon and Intel, one universal build): open the `.dmg` and drag Neat NAS to Applications. The app is not yet notarized, so the first launch needs a right-click → Open.
